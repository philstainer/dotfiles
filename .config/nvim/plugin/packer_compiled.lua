...
_G.packer_plugins = {
  ...
  ["cmp-zsh"] = {
    after_files = { "/Users/phil/.local/share/nvim/site/pack/packer/opt/cmp-zsh/after/plugin/cmp_zsh.lua" },
    load_after = {
      ["nvim-cmp"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/Users/phil/.local/share/nvim/site/pack/packer/opt/cmp-zsh",
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-path", "cmp-nvim-lua", "cmp-zsh", "cmp-tabnine" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
