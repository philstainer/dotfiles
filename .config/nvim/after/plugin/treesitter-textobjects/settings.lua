...
local ok_mapper, Mapper = pcall(require, 'nvim-mapper')
if not ok_mapper then return end
...
Mapper.map_virtual('o', 'ax', '', {}, 'Navigation',
                   'treesitter_attribute_outer',
                   'Attribute (html, xml) outer motion')
Mapper.map_virtual('o', 'ix', '', {}, 'Navigation',
                   'treesitter_attribute_inner',
                   'Attribute (html, xml) inner motion')
...
Mapper.map_virtual('o', '<leader>rP', '', {}, 'Navigation',
                   'treesitter_swap_parameter_previous',
                   'Swap parameter to previous')

Mapper.map_virtual('o', ']m', '', {}, 'Navigation',
                   'treesitter_next_function_start',
...
Mapper.map_virtual('o', '[M', '', {}, 'Navigation',
                   'treesitter_previous_function_end',
                   'Go to previous function (end)')

Mapper.map_virtual('o', '[[', '', {}, 'Navigation',
                   'treesitter_previous_class_start',
